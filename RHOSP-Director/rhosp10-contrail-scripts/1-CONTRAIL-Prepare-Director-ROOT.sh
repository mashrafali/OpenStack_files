...
baseurl=http://resources/RHEL-REPO/rhel-7-server-openstack-10-optools-rpms/Packages    
enabled=1
gpgcheck=0

[equinox-rhel-7-server-openstack-10-rpms]
name=Equinox rhel-7-server-openstack-10-rpms       
baseurl=http://resources/RHEL-REPO/rhel-7-server-openstack-10-rpms/Packages    
enabled=1
gpgcheck=0

[equinox-rhel-7-server-openstack-10-tools-rpms]
name=Equinox rhel-7-server-openstack-10-tools-rpms       
baseurl=http://resources/RHEL-REPO/rhel-7-server-openstack-10-tools-rpms/Packages    
enabled=1
gpgcheck=0
...
baseurl=http://resources/RHEL-REPO/rhel-7-server-rhceph-2-mon-rpms/Packages    
enabled=1
gpgcheck=0

[equinox-rhel-7-server-rhceph-2-osd-rpms]
name=Equinox rhel-7-server-rhceph-2-osd-rpms       
baseurl=http://resources/RHEL-REPO/rhel-7-server-rhceph-2-osd-rpms/Packages    
enabled=1
gpgcheck=0

[equinox-rhel-7-server-rhceph-2-tools-rpms]
name=Equinox rhel-7-server-rhceph-2-tools-rpms       
baseurl=http://resources/RHEL-REPO/rhel-7-server-rhceph-2-tools-rpms/Packages    
enabled=1
gpgcheck=0
...
[equinox-Juniper-Contrail]
name=Equinox Juniper-Contrail
baseurl=http://resources/RHEL-REPO/Juniper-Contrail/Packages                  
enabled=1
