...
--network network=br0,model=virtio,portgroup=overcloud,mac=00:11:22:33:00:$i$i \
...
--vcpus=6 \
--disk size=45,bus=virtio \
--network network=br0,model=virtio,portgroup=overcloud,mac=00:11:22:33:11:$i$i \
--network network=br1,model=virtio \
--pxe \
--noautoconsole \
--serial pty --console pty,target_type=virtio \
...
--disk size=60,bus=virtio \
--disk size=60,bus=virtio \
--network network=br0,model=virtio,portgroup=overcloud,mac=00:11:22:33:22:$i$i \
--network network=br1,model=virtio \
--pxe \
--noautoconsole \
--serial pty --console pty,target_type=virtio \
...
--vcpus=6 \
--disk size=45,bus=virtio \
--network network=br0,model=virtio,portgroup=overcloud,mac=00:11:22:33:33:$i$i \
--network network=br1,model=virtio \
--pxe \
--noautoconsole \
--serial pty --console pty,target_type=virtio \
...
--vcpus=6 \
--disk size=45,bus=virtio \
--network network=br0,model=virtio,portgroup=overcloud,mac=00:11:22:33:44:$i$i \
--network network=br1,model=virtio \
--pxe \
--noautoconsole \
--serial pty --console pty,target_type=virtio \
...
--network network=br0,model=virtio,portgroup=overcloud,mac=00:11:22:33:55:$i$i \
--network network=br1,model=virtio \
--pxe \
--noautoconsole \
--serial pty --console pty,target_type=virtio \
