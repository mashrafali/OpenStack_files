...
ironic node-update contrail-controller-0 replace properties/capabilities='node:contrail-controller-0,boot_option:local'
ironic node-update contrail-controller-1 replace properties/capabilities='node:contrail-controller-1,boot_option:local'
ironic node-update contrail-controller-2 replace properties/capabilities='node:contrail-controller-2,boot_option:local'
ironic node-update contrail-analytics-0 replace properties/capabilities='node:contrail-analytics-0,boot_option:local'
ironic node-update contrail-analytics-1 replace properties/capabilities='node:contrail-analytics-1,boot_option:local'
ironic node-update contrail-analytics-2 replace properties/capabilities='node:contrail-analytics-2,boot_option:local'
ironic node-update contrail-analytics-database-0 replace properties/capabilities='node:contrail-analytics-database-0,boot_option:local'
ironic node-update contrail-analytics-database-1 replace properties/capabilities='node:contrail-analytics-database-1,boot_option:local'
ironic node-update contrail-analytics-database-2 replace properties/capabilities='node:contrail-analytics-database-2,boot_option:local'
